...
namespace mpark {
  ...
  namespace detail { struct in_place_t { explicit in_place_t() = default; }; }
  ...
  namespace detail { constexpr in_place_t in_place{}; }
...
#pragma warning(disable : 4244)
      ...
      inline explicit constexpr alt(detail::in_place_t, Args &&... args)
...
#define MPARK_VARIANT_RECURSIVE_UNION(destructible_trait, destructor)      \
  ...
  union recursive_union<destructible_trait, Index, T, Ts...> {             \
    ...
    inline explicit constexpr recursive_union(in_place_index_t<0>,         \
                                              Args &&... args)             \
        : head_(detail::in_place_t{}, lib::forward<Args>(args)...) {}      \
                                                                           \
    ...
    class constructor : public destructor<Traits> {
      ...
      inline static T &construct_alt(alt<I, T> &a, Args &&... args) {
        ::new (static_cast<void *>(lib::addressof(a)))
            alt<I, T>(detail::in_place_t{}, lib::forward<Args>(args)...);
        return a.value;
      }
